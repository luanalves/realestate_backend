...
- [ ] T001 Create module scaffold: dirs + empty `__init__.py` files + stub `__manifest__.py` for `18.0/extra-addons/thedevkitchen_estate_credit_check/` (models/, controllers/, services/, views/, security/, data/, tests/)
