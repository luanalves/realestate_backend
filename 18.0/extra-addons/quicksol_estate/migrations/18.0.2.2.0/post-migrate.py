...
def migrate(cr, version):
    ...
    _create_index(
        cr, "real_estate_proposal_state_idx", "real_estate_proposal", "(state)"
    )
    _create_index(
        cr,
        "real_estate_proposal_state_company_idx",
        "real_estate_proposal",
        "(state, company_id)",
    )
    _create_index(
        cr,
        "real_estate_proposal_property_state_created_idx",
        "real_estate_proposal",
        "(property_id, state, create_date)",
    )
