...
class TestAgentPerformance(TransactionCase):
    ...
    def test_get_agent_performance(self):
        ...
        self.assertEqual(
            set(self.agent_a1.commission_transaction_ids.ids),
    ...
    def test_performance_multi_tenant_isolation(self):
        ...
        self.assertEqual(
            len(company_a_transactions), 3, "Company A should have 3 transactions"
        )
        self.assertEqual(
            len(company_b_transactions), 5, "Company B should have 5 transactions"
        )
            ...
            self.env["real.estate.commission.transaction"].create(
                {
                    ...
                    / 0.03,  # Reverse calculate transaction amount
