...
class TestRBACPortal(TransactionCase):
    ...
    def test_portal_user_uploads_document(self):
        ...
        try:
            ...
            sale_read = self.Sale.with_user(self.portal_user_john).search(
                [("id", "=", sale.id)]
            )
    ...
    def test_portal_user_views_public_property_listings(self):
        ...
        try:
            ...
            self.assertGreaterEqual(
                len(properties), 0
            )  # May or may not have access depending on ACL
        except AccessError:
    ...
    def test_portal_user_cannot_modify_contracts(self):
        ...
        with self.assertRaises(AccessError):
            sale.with_user(self.portal_user_john).write({"sale_price": 500000.00})
