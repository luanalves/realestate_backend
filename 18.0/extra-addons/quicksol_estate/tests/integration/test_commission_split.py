...
class TestCommissionSplit(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.property_type = cls.env["real.estate.property.type"].search(
            [("name", "=", "House")], limit=1
        )
        ...
        if not cls.state:
            cls.state = cls.env["res.country.state"].create(
                {"name": "São Paulo", "code": "SP", "country_id": cls.country.id}
            )
    ...
    def test_commission_split_default_30_70(self):
        ...
        result = self.commission_rule.calculate_split_commission(
            self.property_with_split, 500000.00, "sale"
        )
    ...
    def test_commission_split_configurable_percentage(self):
        ...
        self.IrConfigParameter.set_param(
            "quicksol_estate.prospector_commission_percentage", "0.40"
        )
        ...
        # Reset to default
        self.IrConfigParameter.set_param(
            "quicksol_estate.prospector_commission_percentage", "0.30"
        )
    ...
    def test_commission_split_no_split_when_no_prospector(self):
        ...
        result = self.commission_rule.calculate_split_commission(
            self.property_no_split, 500000.00, "sale"
        )
    ...
    def test_commission_split_no_split_when_same_agent(self):
        ...
        result = self.commission_rule.calculate_split_commission(
            self.property_same_agent, 500000.00, "sale"
        )
    ...
    def test_commission_split_invalid_percentage_raises_error(self):
        ...
        self.IrConfigParameter.set_param(
            "quicksol_estate.prospector_commission_percentage", "1.5"
        )
    ...
    def test_commission_split_zero_percentage(self):
        ...
        self.IrConfigParameter.set_param(
            "quicksol_estate.prospector_commission_percentage", "0.0"
        )
    ...
    def test_commission_split_100_percentage(self):
        ...
        self.IrConfigParameter.set_param(
            "quicksol_estate.prospector_commission_percentage", "1.0"
        )
    ...
    def test_commission_split_requires_property_with_agent(self):
        ...
        with self.assertRaises(ValidationError):
            self.commission_rule.calculate_split_commission(
                property_no_agent, 500000.00, "sale"
            )
