...
class TestAgentAPIPerformance(HttpCase):
    ...
    def test_list_agents_performance_1000_records(self):
        ...
        self.assertLess(
            response_time, 500, f"Response time {response_time:.2f}ms exceeds 500ms SLA"
        )
        ...
        print(
            f"[PERFORMANCE] SLA: <500ms | Actual: {response_time:.2f}ms | Status: PASS"
        )
    ...
    def test_list_agents_pagination_performance(self):
        ...
        print(
            f"[PERFORMANCE] Max degradation: {max_degradation:.2f}x | SLA: <3.0x | Status: PASS"
        )
    ...
    def test_get_agent_detail_performance(self):
        ...
        print(
            f"[PERFORMANCE] SLA: <100ms | Actual: {response_time:.2f}ms | Status: PASS"
        )
