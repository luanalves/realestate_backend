...
from odoo.addons.quicksol_estate.models.observers.commission_split_observer import (
    CommissionSplitObserver,
)
...
class TestCommissionSplitObserver(TransactionCase):
    ...
    def test_observer_skips_sale_without_prospector(self):
        ...
        self.assertEqual(
            len(prospector_transaction), 0, "No split transaction should be created"
        )
