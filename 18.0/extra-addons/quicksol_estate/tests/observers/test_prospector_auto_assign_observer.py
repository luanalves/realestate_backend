...
from odoo.addons.quicksol_estate.models.observers.prospector_auto_assign_observer import (
    ProspectorAutoAssignObserver,
)
...
class TestProspectorAutoAssignObserver(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.prospector_group = cls.env.ref(
    ...
    def test_observer_handles_property_before_create_event(self):
        ...
        self.observer.handle(
            "property.before_create", vals, env=self.env.with_user(self.prospector_user)
        )
    ...
    def test_observer_skips_non_prospector_users(self):
        ...
        self.observer.handle(
            "property.before_create", vals, env=self.env.with_user(self.manager_user)
        )
    ...
    def test_observer_handles_prospector_without_agent_record(self):
        ...
        self.observer.handle(
            "property.before_create", vals, env=self.env.with_user(prospector_no_agent)
        )
    ...
    def test_observer_ignores_other_events(self):
        ...
        self.observer.handle(
            "property.created", vals, env=self.env.with_user(self.prospector_user)
        )
