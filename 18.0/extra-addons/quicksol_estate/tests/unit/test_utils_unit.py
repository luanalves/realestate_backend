...
class TestUtilsResponse(TransactionCase):
    ...
    def test_error_response_import(self):
        ...
        from odoo.addons.quicksol_estate.controllers.utils.response import (
            error_response,
        )
...
class TestUtilsSerializers(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.location_type = cls.env["real.estate.location.type"].create(
            {"name": "Test Location", "code": "test_loc", "sequence": 1}
        )
    ...
    def test_serialize_property_import(self):
        ...
        from odoo.addons.quicksol_estate.controllers.utils.serializers import (
            serialize_property,
        )
