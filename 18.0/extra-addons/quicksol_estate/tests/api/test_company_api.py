...
class TestCreateCompany(HttpCase):
    ...
    def test_01_owner_creates_company_auto_linkage(self):
        ...
        self.assertIn(
            company_id,
            self.owner_user.company_ids.ids,
    ...
    def test_04_invalid_cnpj_rejected(self):
        ...
        self.assertEqual(
            response.status_code, 400, "Should return 400 Bad Request for invalid CNPJ"
        )
    ...
    def test_05_invalid_email_rejected(self):
        ...
        self.assertEqual(
            response.status_code, 400, "Should return 400 Bad Request for invalid email"
        )
    ...
    def test_08_company_list_multi_tenancy(self):
        ...
        self.assertIn(
            company_id, company_ids, "Owner should see their own company in list"
        )
    ...
    def test_11_company_soft_delete(self):
        ...
        self.assertFalse(
            company.active, "Company should be soft-deleted (active=False)"
        )
...
class TestManagerReadOnly(HttpCase):
    ...
    def test_manager_can_read_companies(self):
        ...
        self.assertEqual(
            response.status_code, 200, "Manager should be able to read companies"
        )
    ...
    def test_owner_retains_full_access(self):
        ...
        self.assertEqual(
            create_response.status_code, 201, "Owner should be able to create company"
        )
